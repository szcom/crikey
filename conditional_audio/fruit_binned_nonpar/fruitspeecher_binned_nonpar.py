...
from kdllib import save_results_as_html
...
if __name__ == "__main__":
    ...
    init_x = as_shared(np_zeros((minibatch_size, input_dim)))
    ...
    pred1 = softmax(l2.dot(softmax1_proj) + softmax1_b)
    pred2 = softmax(l2.dot(softmax2_proj) + softmax2_b)
